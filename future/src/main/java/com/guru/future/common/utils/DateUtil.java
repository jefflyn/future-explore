...
public class DateUtil {
    ...
    static {
        HOLIDAY_MAP.put(Calendar.JANUARY, Lists.newArrayList(2, 23, 24, 25, 26, 27));
//        HOLIDAY_MAP.put(Calendar.FEBRUARY, Lists.newArrayList(1, 2, 3, 4));
        HOLIDAY_MAP.put(Calendar.APRIL, Lists.newArrayList(5));
        HOLIDAY_MAP.put(Calendar.MAY, Lists.newArrayList(1, 2, 3));
        HOLIDAY_MAP.put(Calendar.JUNE, Lists.newArrayList(22, 23));
        HOLIDAY_MAP.put(Calendar.SEPTEMBER, Lists.newArrayList(29));
        HOLIDAY_MAP.put(Calendar.OCTOBER, Lists.newArrayList(2, 3, 4, 5, 6));
    }
